...
export async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    return json({ ok: false, connected: false, error: item.message, result: item }, 502);
  }
}
