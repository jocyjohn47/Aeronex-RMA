...
function drawCart(){
  ...
  if(unitHead) unitHead.textContent = `Unit Price (${cur})`;
  if(totalHead) totalHead.textContent = `Total (${cur})`;
...
async function submitOrder(){
  ...
  let p={
    ...
    items:pricedItems,
    notes:(($('spareNotes')&&$('spareNotes').value)||'').trim()
  };
